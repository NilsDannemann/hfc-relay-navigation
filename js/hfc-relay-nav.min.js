...
var HFCRelayNav = function () {
  ...
  _createClass(HFCRelayNav, [{
    ...
    value: function init(sel, options) {
      ...
      root._map(submenu, function (item) {
        item.getElementsByTagName('a')[0].addEventListener('click', function (event) {
          ...
          var maxWidth = root.options.vpWidth;
      ...
      document.addEventListener('click', function (event) {
        if (!root._getClosest(event.target, '.has-submenu') && !root._getClosest(event.target, '.priority-nav-is-visible') && event.target !== event.target.querySelector('.has-submenu')) {
           ...
           */
          var elementsToHide = selector.querySelectorAll('ul.show');
          // let elementsToHide = selector.querySelectorAll('li.is-open');
          root._map(elementsToHide, function (element) {
     ...
     */
    value: function _applyClassToElement(selector, className) {
      var root = this;
      var lis = selector.querySelectorAll('li');

      root._map(lis, function (li) {
